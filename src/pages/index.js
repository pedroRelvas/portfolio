...
import { ThemeProvider, Typography, Chip } from "@mui/material";
...
const projectCardsProps = [
  {
    href: './millerVillageTycoon',
    imageSrc: MillerVillagePreview, // Example image URL
      ...
      <ThemeProvider theme={theme}>
          <Layout>
            ...
            <Box mt={3} textAlign='center'>
              <Chip label="Under Maintenance (still, you can see the projects! :)" color="warning" mx="auto"/>
            </Box>
        ...
        {projectCardsProps.map((props, index) => (
          <LazyProjectCard key={index} {...props} />
        ))}
                {/* Miller Village */}
