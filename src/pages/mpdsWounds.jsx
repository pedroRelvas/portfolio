                ...
                firstProjectStep={
                  <ProjectSection topic="The Beginning">
                    ...
                    <Box textAlign='center'>
                      <img src={mpdsAndroidFirstSection} width="800" alt="Mpds Wounds Hospital Illustration"/>
                    </Box>
                    ...
                    <Box textAlign='center'>
                      <img src={mpdsWoundsPatientList} width="500" alt="Patient List UI" />
                    </Box>
                    ...
                    <Box textAlign='center'>
                      <img src={mpdsWoundsScreenShootsApp} width="800" alt="Screen Shoots"/>
                    </Box>
